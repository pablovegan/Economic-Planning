...
if __name__ == "__main__":
    ...
    sheet_names = ["Table1", "Table3"]

    for name in excel_names:
        excel_path = join("example", "Spain", "data", name + ".xlsx")

        supply_matrix = csr_matrix(load_excel(excel_path, "Table1", 10, 3, 123, 83))

        use_matrix = csr_matrix(load_excel(excel_path, sheet_name, 4, 3, 63, 61))
